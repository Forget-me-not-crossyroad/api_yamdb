# Generated by Django 3.2 on 2023-11-07 07:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[reviews.validators.validate_user_name])),
                ('email', models.EmailField(max_length=254, unique=True, validators=[reviews.validators.validate_user_name])),
                ('first_name', models.CharField(blank=True, max_length=150)),
                ('last_name', models.CharField(blank=True, max_length=150)),
                ('bio', models.CharField(blank=True, max_length=500, null=True)),
                ('role', models.CharField(default='user', help_text='Одна из: user, moderator, admin', max_length=15, validators=[reviews.validators.validate_profile_group], verbose_name='Группа пользователя')),
